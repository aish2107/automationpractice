...
public class adactin_hotel_demo {
	...
	public static void main(String[] args) {
		...
		String o_id = driver.findElement(By.id("order_no")).getAttribute("value");
		//System.out.println(o_id);
		
		System.out.println("Congratulations!! Your booking is confirmed. Order ID is:" +o_id);
